...
class DimCustomerSilverETL(TableETL):
    ...
    def extract_upstream(self) -> List[ETLDataset]:
        customer_etl = CustomerBronzeETL(
            spark=self.spark,
        ...
        return [
            customer_etl.read(partition_values=None),
    ...
    def transform_upstream(self, upstream_datasets: List[ETLDataset]) -> ETLDataset:
        ...
        dim_customer_data = (
            ...
            .select(
                ...
                F.col("geolocation_lat"),
                F.col("geolocation_lng"),
                customer_data["updated_date"].alias("updated_date")
            )
        )
        ...
        return ETLDataset(
            ...
            records_pulled=dim_customer_data.count()
        )
    ...
    def read(self, partition_values: Optional[Dict[str, str]] = None) -> ETLDataset:
        ...
        dim_customer_data = raw_data.select(
            F.col("customer_id"),
            F.col("customer_unique_id"),
            F.col("customer_zip_code_prefix"),
            F.col("customer_city"),
